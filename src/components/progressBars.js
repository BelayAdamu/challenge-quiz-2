            ...
            <div className="scores-wrapper">
                <div className="txt-scores-wrapper">
                    <div className="txt-actual-score">
                        <p>Score {qtnNum === 1? Math.floor(correctAnswers*100/1): Math.floor(correctAnswers*100/(qtnNum - 1))}%</p>
                        {console.log("STATUS", correctAnswers, qtnNum)}
                    </div>
                    <div className="txt-max-score">
                        <p>Max Score {Math.floor((numOfQtns - wrongAnswers)*100/numOfQtns)}%</p>
                    </div>
                </div>
